...
struct ContentView: View {
    ...
    @State private var titles = ["Number System Conversion", "Date Conversion", "QR Code Reader", "QR Code Generator", "Color Picker", "Num Sys Conversion", "Num Sys Conversion", "Demo Detail"]
